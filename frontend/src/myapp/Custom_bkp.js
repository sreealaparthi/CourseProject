...
function Custom(props) {
    ...
    //                           data-type="video/mp4"
    //                           data-src={`lecture_videos/textanalytics/${analyticsItem.name}`}/>
    //                             <span className="able-track"
    //                                   data-kind="captions"
    //                                   data-src={`transcripts/textanalytics/${getTranscript('textanalytics', analyticsItem.name)}`}
    //                                   data-srclang="en"
    //                                   data-label="English"/>
    //                             <button type="button" ref={myRefname} style={{'display': 'none'}}
    //                                     value={`transcripts/textanalytics/${getTranscript('textanalytics', analyticsItem.name)}`}>
    //                                 {`lecture_videos/textanalytics/${analyticsItem.name}`}
    //                             </button>
    //                         </li>
    //                 )
    //             })}
